...
//        closeDB();
    ...
    public void updateValueIntoDatabase(String modelNumber, String setUpCompletedDateTime, String setUpModifiedDateTime, String createdON, int setUpCompletedValue, String spinnerACHValue, String spinnerPolarityValue,
                                        String strSupplyValue, String strExhaustValue, String mLockValue, int mSupplyEdt, int mExhaustEdt,
                                        String mStrCompanyName, String mStrBlowerName, String mStrBuildingName,
                                        String mStrRoomName, String mStrIpAddress, String mStrExitSupplyValue, String mStrExitExhaustValue) {
        String updateQuery = "";
        if (mSupplyEdt == 1) {
            if (!mLockValue.isEmpty() || !mLockValue.equalsIgnoreCase("")) {
...
//                    DatabaseTable.COL_BLRACKSETUP_EXHAUSTWC + " = " + "'" + strExhaustValue + "'" + ", " +
                        ...
                        DatabaseTable.COL_BLRACKSETUP_COMPANY_NAME + " = " + "'" + mStrCompanyName + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_BLOWER_NAME + " = " + "'" + mStrBlowerName + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_BUILDING_NAME + " = " + "'" + mStrBuildingName + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_ROOM_NAME + " = " + "'" + mStrRoomName + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_IP_ADDRESS + " = " + "'" + mStrIpAddress + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_CREATED_ON + " = " + "'" + createdON + "'" + " where " +
                        DatabaseTable.COL_BLRACKSETUP_MODEL_NO + " = " + "'" + modelNumber + "'" + " and " +
                        DatabaseTable.COL_BLRACKSETUP_ACH + " = " + "'" + spinnerACHValue + "'" + " and " +
//                        DatabaseTable.COL_BLRACKSETUP_POLARITY + " = " + "'" + spinnerPolarityValue + "'" + " and " +
                        DatabaseTable.COL_BLRACKSETUP_WITH_WITHOUT_LOCK + " = " + "'" + mLockValue + "'";
            }
//            else if (!mStrExitSupplyValue.isEmpty() || !mStrExitSupplyValue.equalsIgnoreCase("")) {
...
//                        DatabaseTable.COL_BLRACKSETUP_ACH + " = " + "'" + spinnerACHValue + "'" + " and " +
//                        DatabaseTable.COL_BLRACKSETUP_POLARITY + " = " + "'" + spinnerPolarityValue + "'" + " and " +
//                        DatabaseTable.COL_BLRACKSETUP_SUPPLYCFM + " = " + "'" + mStrExitSupplyValue + "'" + " and " +
//                        DatabaseTable.COL_BLRACKSETUP_POLARITY + " = " + "'" + spinnerPolarityValue + "'" + " and " +
//                        DatabaseTable.COL_BLRACKSETUP_WITH_WITHOUT_LOCK + " = " + "'" + mLockValue + "'";
//            }
            else {
...
//                        DatabaseTable.COL_BLRACKSETUP_EXHAUSTWC + " = " + "'" + mStrExitExhaustValue + "'" + " and " +
                        DatabaseTable.COL_BLRACKSETUP_WITH_WITHOUT_LOCK + " = " + "'" + mLockValue + "'";
            } else if (!mStrExitExhaustValue.isEmpty() || !mStrExitExhaustValue.equalsIgnoreCase("")) {
                updateQuery = "UPDATE " + DatabaseTable.TBL_BLRACKSETUP + " SET " +
//                    DatabaseTable.COL_BLRACKSETUP_SUPPLYCFM + " = " + "'" + strSupplyValue + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_EXHAUSTWC + " = " + "'" + strExhaustValue + "'" + ", " +
                        DatabaseTable.COL_BLRACKSETUP_ISSETUPCOMPLETED + " = " + "'" + setUpCompletedValue + "'" + ", " +
...
//                    DatabaseTable.COL_BLRACKSETUP_SUPPLYCFM + " = " + "'" + strSupplyValue + "'" + ", " +
                        ...
                        DatabaseTable.COL_BLRACKSETUP_POLARITY + " = " + "'" + spinnerPolarityValue + "'" + " and " +
                        DatabaseTable.COL_BLRACKSETUP_SUPPLYCFM + " = " + "'" + strSupplyValue + "'" + " and " +
                        DatabaseTable.COL_BLRACKSETUP_EXHAUSTWC + " = " + "'" + mStrExitExhaustValue + "'";
            }

        } else if (!mLockValue.isEmpty() || !mLockValue.equalsIgnoreCase("")) {
            updateQuery = "UPDATE " + DatabaseTable.TBL_BLRACKSETUP + " SET " +
                    DatabaseTable.COL_BLRACKSETUP_ISSETUPCOMPLETED + " = " + "'" + setUpCompletedValue + "'" + ", " +
                    DatabaseTable.COL_BLRACKSETUP_SETUPCOMPLETED_DATETIME + " = " + "'" + setUpCompletedDateTime + "'" + ", " +
                    DatabaseTable.COL_BLRACKSETUP_COMPANY_NAME + " = " + "'" + mStrCompanyName + "'" + ", " +
                    ...
                    DatabaseTable.COL_BLRACKSETUP_POLARITY + " = " + "'" + spinnerPolarityValue + "'" + " and " +
                    DatabaseTable.COL_BLRACKSETUP_SUPPLYCFM + " = " + "'" + strSupplyValue + "'" + " and " +
                    DatabaseTable.COL_BLRACKSETUP_EXHAUSTWC + " = " + "'" + strExhaustValue + "'" + " and " +
                    DatabaseTable.COL_BLRACKSETUP_WITH_WITHOUT_LOCK + " = " + "'" + mLockValue + "'";
        } else {
            updateQuery = "UPDATE " + DatabaseTable.TBL_BLRACKSETUP + " SET " +
//                    DatabaseTable.COL_BLRACKSETUP_SUPPLYCFM + " = " + "'" + strSupplyValue + "'" + ", " +
...
//            String updateQuery = "UPDATE BLRackSetup SET ExhaustWC='-0.011' ,IsSetupcompleted ='0' ,SetupCompletedDateTime = '', CreatedOn = '' WHERE ModelNo = '0JV042' AND ACH = '50' AND Polarity = '+' ";
            ...
            Log.e("Updated : - ", "Updated RackSetUpTable Succesfully");
        } catch (Exception e) {
            Log.e("error", e.getMessage());
        }
